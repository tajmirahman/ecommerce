                                ...
                                <ul class="row grid--uniform mmWrapper">
                                    ...
                                    <li class="lvl-1 col-md-3 col-lg-3 w-34 banner-col">
                                        <div class="banner-wrap">
                                            <a href="shop-left-sidebar.html"><img class="blur-up lazyload" data-src="{{ asset('frontend') }}/assets/images/megamenu/banner-menu.jpg" src="{{ asset('frontend') }}/assets/images/megamenu/banner-menu.jpg" alt="banner" width="600" height="440" /></a>
                                        ...
                                        <div class="grid-products weekly-product gp10 mt-1">
                                            <div class="item">
                                                <div class="product-wrap position-relative">
                                                    ...
                                                    <div class="product-image mb-0">
                                                        <a href="product-layout1.html" class="product-img"><img class="blur-up lazyload" data-src="{{ asset('frontend') }}/assets/images/megamenu/product1.jpg" src="{{ asset('frontend') }}/assets/images/megamenu/product1.jpg" alt="product" title="Product" width="625" height="808" /></a>
                                            ...
                                            <div class="item">
                                                <div class="product-wrap position-relative">
                                                    <!-- Start Product Image -->
                                                    <div class="product-image mb-0">
                                                        <a href="product-layout1.html" class="product-img"><img class="blur-up lazyload" data-src="{{ asset('frontend') }}/assets/images/megamenu/product2.jpg" src="{{ asset('frontend') }}/assets/images/megamenu/product2.jpg" alt="product" title="Product" width="625" height="808" /></a>
                                                    </div>
                                                    <!-- End Product Image -->
                                                    <!-- Start Product Details -->
                                                    <div class="product-details text-center">
                                            ...
                                            <div class="item">
                                                <div class="product-wrap position-relative">
                                                    <!-- Start Product Image -->
                                                    <div class="product-image mb-0">
                                                        <a href="product-layout1.html" class="product-img"><img class="blur-up lazyload" data-src="{{ asset('frontend') }}/assets/images/megamenu/product3.jpg" src="{{ asset('frontend') }}/assets/images/megamenu/product3.jpg" alt="product" title="Product" width="625" height="808" /></a>
                                                    </div>
                                                    <!-- End Product Image -->
                                                    <!-- Start Product Details -->
                                                    <div class="product-details text-center">
